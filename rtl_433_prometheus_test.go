...
func TestParsingToMetrics(t *testing.T) {
	...
	wantTemperature := `
		...
		rtl_433_temperature_celsius{channel="1",id="94",model="Nexus-TH"} 22.6
		rtl_433_temperature_celsius{channel="2",id="184",model="Nexus-TH"} 21.7
		rtl_433_temperature_celsius{channel="3",id="55",model="Ecowitt-WH53"} 18
		rtl_433_temperature_celsius{channel="A",id="7997",model="Acurite-Tower"} 12.6
	`
	...
	wantHumidity := `
		...
		rtl_433_humidity{channel="1",id="94",model="Nexus-TH"} 0.53
		rtl_433_humidity{channel="2",id="184",model="Nexus-TH"} 0.55
		rtl_433_humidity{channel="A",id="7997",model="Acurite-Tower"} 0.91
	`
	...
	wantPacketsReceived := `
		...
		rtl_433_packets_received{channel="1",id="94",model="Nexus-TH"} 1
		rtl_433_packets_received{channel="2",id="184",model="Nexus-TH"} 1
		rtl_433_packets_received{channel="3",id="55",model="Ecowitt-WH53"} 1
		rtl_433_packets_received{channel="A",id="7997",model="Acurite-Tower"} 1
	`
	...
	wantBattery := `
		...
		rtl_433_battery{channel="1",id="94",model="Nexus-TH"} 1
		rtl_433_battery{channel="2",id="184",model="Nexus-TH"} 1
		rtl_433_battery{channel="A",id="7997",model="Acurite-Tower"} 0
	`
